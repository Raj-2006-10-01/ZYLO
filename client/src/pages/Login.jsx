        ...
        <div>
          <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
            ...
            <div>
              ...
              <p>User By 12k+ Devloper</p>
            </div>
          </div>
          <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-linear-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent'>More Then just friend truely connect.</h1>
