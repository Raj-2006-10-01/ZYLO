                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/profile relative w-80 h-40'>
                                    <img
                                        src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo}
                                        alt=""
                                        className='w-full h-full rounded-lg object-cover mt-2'
                                    />

                                    <div className='absolute inset-0 flex items-center justify-center bg-black/30 rounded-lg opacity-0 group-hover/profile:opacity-100 transition'>
                                        <Pencil className='w-5 h-5 text-white' />
                                    </div>
                                </div>
                            </label>
                        ...
                        <div>
                            <label className='block  text-sm font-medium text-gray-700 mb-1'>
                                Bio
                                <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter sort BIO' onChange={(e) => setEditForm({ ...editForm, bio: e.target.value })} value={editForm.bio} />
                            </label>
                        </div>
                        <div>
                            <label className='block  text-sm font-medium text-gray-700 mb-1'>
